...
contract XSushiStrategy is IStrategy, Controllable, AaveInteractor {
  ...
  address public override underlying; // sushi
  ...
  function withdrawToVault(uint256 amountUnderlying) external override restricted {
  ...
  function depositArbCheck() external view override returns(bool) {
    return true;
  }
}
